...
class Config:
    ...
    decay_end: float   = 0.075#. . . . . Ending decay factor for the scheduler
    ...
    ## Network parameters
    hidden_dim: int = 12 # . . . . . . . Dimension of the hidden state
    ...
    ## Testing phase
    plot_horizon: int = 1500 #. . . . . . How many samples to plot when testing
